                    ...
                    <div class="col-lg-12">
                        <div class="card ">
                            <div class="card-header justify-content-center">
                                <a style="background-color:#343957; font-size: 14px;"
                                    class="badge badge-rounded   text-white">What to
                                    do:</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col col-4-lg col-6-sm mt-2 ">
                                        <button type="button" class="btn btn-secondary btn-block text-white" style="background-color:#343957; border:none" data-toggle="modal"
                                            data-target="#transfertmodal">Transfert</button>
                                ...
                                <div class="row justify-content-center mt-2">
                                    <div class="col col-12-lg col-12-sm ">
                                        <button type="button" class="btn btn-secondary btn-block" data-toggle="modal"
                                            data-target="#historymodal">History</button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form method="post" action="{{ url('/recharge') }}">
                                            ...
                                            <div class="form-group">
                                                <label for="message-text" class="col-form-label">Txid:</label>
