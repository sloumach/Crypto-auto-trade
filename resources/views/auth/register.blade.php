                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="invitation_code"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Invitational code') }}</label>

                                <div class="col-md-6">
                                    <input id="invitation_code" type="text" class="form-control" name="invitation_code"
                                        required autocomplete="invitation_code">
                                </div>
                            </div>
